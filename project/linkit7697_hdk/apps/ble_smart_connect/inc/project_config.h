...
#define APP_BLE_SMTCN_DEVICE_NAME           "BLE_SMTCN"
#define APP_BLE_SMTCN_SERVICE_UUID          (0x18AA)
#define APP_BLE_SMTCN_CHAR_UUID             (0x2AAA)

#define APP_BLE_SMTCN_CHAR_VALUE_HANDLE     0x0016
